...
from fun_bag_agent.agent import get_analytics

SERVICE_NAME: Final = "fun-bag-agent"
EVENT_SUBJECT: Final = "system-events.fun-bag-agent"
EVENT_SOURCE: Final = "com.qlik/fun-bag-agent"
